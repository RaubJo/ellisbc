    ...
    return (
        <Suspense>
            <Show when={events()?.length > 0}>
                <section class="w-full bg-[#B5AA9D] py-12 flex">
                    <div class="container max-w-5xl mx-auto px-10" >
                        ...
                        <div class="flex flex-col sm:flex-row justify-between w-full gap-6">
                            <For each={events().slice(0, count())}>
                                {(event) => 
                                    <div class="bg-[#F0EEEB] aspect-3/4 shadow-xl relative w-3/4 mx-auto sm:w-1/2 md:w-1/3">
                                        ...
                                        <div class="absolute w-full bg-[#B5AA9DAA] h-fit flex pl-4 bottom-0">
