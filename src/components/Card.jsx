                ...
                <div className="mx-auto h-full flex flex-col max-w-sm bg-white border rounded-lg shadow-lg p-7 border-neutral-200/60">
                    ...
                    {this.shouldShowButton() &&
                        <button onClick={() => window.open(this.state.url)}
                            className="inline-flex items-center w-3/4 mx-auto h-10 px-4 justify-end text-sm font-medium text-white transition-colors rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none bg-neutral-950 hover:bg-neutral-950/90">
