export default function ServiceTimes() {
    return (
        <section class="w-full relative pb-4 h-fit">
            <img src="/images/pew.png" class="inset-0 w-full absolute -z-10 h-full object-cover" />

            <div class="bg-white h-fit w-fit p-(--padding) pb-0 mx-auto [--padding:--spacing(8)] md:[--padding:--spacing(10)] mb-18 sm:mb-24 sm:mr-[10vw] sm:ml-auto">
